...
const MessageSchema = mongoose.Schema(
  {
    ...
    // ==========================================
    // PHASE 1: TRIPLE HANDSHAKE MERGE UPDATE
    // ==========================================
    localId: { 
      type: String 
    ...
    status: {
      type: String,
      // FIX: Added "processing", "sent", "delivered", and "read" to match the service and frontend states
      enum: ["pending", "processing", "sent", "delivered", "read", "sent_to_server", "delivered_to_device", "read_by_user"],
      default: "pending", // Default state before the server confirms receipt
    },
    // ==========================================
...
// 7. NEW: Optimize looking up messages by localId for the ACK process
MessageSchema.index({ localId: 1 });
